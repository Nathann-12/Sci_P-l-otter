...
def _excel_cell_has_value(value: Any) -> bool:
    ...
    try:
        ...
        logger.debug("_excel_cell_has_value: suppressed exception", exc_info=True)
    return True
...
def _clean_cell_value(value: Any) -> Any:
    ...
    try:
        ...
        logger.debug("_clean_cell_value: suppressed exception", exc_info=True)
    return value
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            logger.debug("read_excel: suppressed exception", exc_info=True)
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logger.debug("read_netcdf_quick: suppressed exception", exc_info=True)
...
def inspect_netcdf(path: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            logger.debug("inspect_netcdf: suppressed exception", exc_info=True)
...
def slice_netcdf(path: Path, data_var: str, time_var: str, index_map: Dict[str, int]) -> Tuple[pd.DataFrame, Dict[str, Any]]:
    ...
    try:
        ...
        try:
            ...
            logger.debug("slice_netcdf: suppressed exception", exc_info=True)
...
def _to_datetime_series(name: str, arr: np.ndarray) -> pd.Series:
    ...
    try:
        ...
        logger.debug("_to_datetime_series: suppressed exception", exc_info=True)
...
def _names_from_info_or_iter(cdf, path: Path) -> List[str]:
    ...
    def _as_list(x):
        ...
        try:
            ...
            logger.debug("_as_list: suppressed exception", exc_info=True)
        return [x]
    ...
    try:
        ...
        logger.debug("_names_from_info_or_iter: suppressed exception", exc_info=True)
        ...
        try:
            ...
            if isinstance(info, dict) and "Variables" in info:
                ...
                try:
                    ...
                    logger.debug("read_cdf: suppressed exception", exc_info=True)
...
def inspect_cdf_istp(path: Path) -> Dict[str, Any]:
    ...
    for name in names:
        ...
        try:
            ...
            logger.debug("inspect_cdf_istp: suppressed exception", exc_info=True)
