...
_QTA_ICON_MAP = {
    ...
    "sci_statistics": "mdi.sigma",
    "sci_global_fit": "mdi.chart-multiline",
    "sci_peak_analyzer": "mdi.chart-bell-curve",
    "sci_recipes": "mdi.notebook-outline",
    "sci_recalculate": "mdi.refresh-auto",
    "sci_batch": "mdi.folder-play-outline",
    "matrix_gridding": "mdi.grid-large",
    "matrix_heatmap": "mdi.blur",
    "matrix_surface": "mdi.terrain",
...
class MainWindow(
    ...
    def __init__(self):
        ...
        # ปิด Book (กากบาท) → sync active data (สร้าง Book ว่างใหม่ถ้าปิดอันสุดท้าย)
